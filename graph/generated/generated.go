...
func (ec *executionContext) field_Mutation_createShip_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNNewShip2starfieldᚋgraphᚋmodelᚐNewShip(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createShip(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNShip2ᚖstarfieldᚋgraphᚋmodelᚐShip(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_ships(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Ship)
	fc.Result = res
	return ec.marshalNShip2ᚕᚖstarfieldᚋgraphᚋmodelᚐShipᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Ship_modules(ctx context.Context, field graphql.CollectedField, obj *model.Ship) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNModule2ᚕᚖstarfieldᚋgraphᚋmodelᚐModuleᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNModule2ᚕᚖstarfieldᚋgraphᚋmodelᚐModuleᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Module) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNModule2ᚖstarfieldᚋgraphᚋmodelᚐModule(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNModule2ᚖstarfieldᚋgraphᚋmodelᚐModule(ctx context.Context, sel ast.SelectionSet, v *model.Module) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNNewShip2starfieldᚋgraphᚋmodelᚐNewShip(ctx context.Context, v interface{}) (model.NewShip, error) {
	res, err := ec.unmarshalInputNewShip(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNShip2starfieldᚋgraphᚋmodelᚐShip(ctx context.Context, sel ast.SelectionSet, v model.Ship) graphql.Marshaler {
	return ec._Ship(ctx, sel, &v)
}

func (ec *executionContext) marshalNShip2ᚕᚖstarfieldᚋgraphᚋmodelᚐShipᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Ship) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNShip2ᚖstarfieldᚋgraphᚋmodelᚐShip(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNShip2ᚖstarfieldᚋgraphᚋmodelᚐShip(ctx context.Context, sel ast.SelectionSet, v *model.Ship) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
